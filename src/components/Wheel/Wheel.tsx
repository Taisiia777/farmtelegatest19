...
{step === 1 && (
  ...
  {t('more_spins')}
            ...
            <img src="img/pages/home/menu/WheelCenter4.png" style={{width: '90vw', display:'flex', zIndex:'11', position:'absolute', top: '143px', transform: `rotate(${rotation}deg)`,transition: isSpinning ? "transform 5s cubic-bezier(0.25, 0.1, 0.25, 1)" : "none",transformOrigin: "center" }} alt="Wheel" />
            <img src="img/pages/home/menu/WheelBorder4.png" style={{width: '115vw', display:'flex',  zIndex:'10',  position:'absolute', top: '100px'}} alt="Wheel" />
