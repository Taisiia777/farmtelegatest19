        ...
        <div className={cn("content__person-img", "_first")} ref={wheelRef}>
         ...
         //   }}
          ...
          {t('more_spins')}
            ...
            <img src="img/global/spin.png" className={cn("greeting__next")} style={{width: '122px', height: '46px', position: 'absolute', top: '70vh',  left: '50%', transform: 'translateX(-50%)'}} alt="Spin" onClick={spin} />
