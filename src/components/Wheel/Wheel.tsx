...
{step === 1 && (
  ...
  {t('more_spins')}
            ...
            <img src="img/pages/home/menu/WheelCenter3.png" style={{width: '11ovw', display:'flex', zIndex:'11', position:'absolute', top: '140px', transform: `rotate(${rotation}deg)`,transition: isSpinning ? "transform 5s cubic-bezier(0.25, 0.1, 0.25, 1)" : "none",transformOrigin: "center" }} alt="Wheel" />
            <img src="img/pages/home/menu/WheelBorder.png" style={{width: '115vw', display:'flex',  zIndex:'10',  position:'absolute', top: '100px'}} alt="Wheel" />
...
/>
            ...
            <p className={`${cn("content__text", "_first")}` + ' textInvite3'} style={{width: '122px', height: '20px', position: 'absolute', top: '70vh', zIndex:'11', }} onClick={spin}>
          {t('spin')}
          </p>
          </div>
        </div>
