...
{step === 1 && (
  ...
  {t('more_spins')}
            ...
            <img src="img/pages/home/menu/WheelBorder4.png" style={{width: '100vw', display:'flex',  zIndex:'10',  position:'absolute', top: '50px'}} alt="Wheel" />
            <img src="img/pages/home/menu/triangle.png" style={{width: '58px', display:'flex',  zIndex:'10',  position:'absolute', top: '115px'}} alt="Wheel" />
