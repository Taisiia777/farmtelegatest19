...
{step === 1 && (
  ...
  {t('more_spins')}
            ...
            <img src="img/pages/home/menu/WheelCenter3.png" style={{width: '90vw', display:'flex', zIndex:'11', position:'absolute', top: '143px', transform: `rotate(${rotation}deg)`,transition: isSpinning ? "transform 5s cubic-bezier(0.25, 0.1, 0.25, 1)" : "none",transformOrigin: "center" }} alt="Wheel" />
