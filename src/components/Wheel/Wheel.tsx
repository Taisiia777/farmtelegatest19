...
{step === 1 && (
  ...
  {t('more_spins')}
            ...
            <img src="img/pages/home/menu/WheelCenter4.png" style={{width: '105vw', display:'flex', zIndex:'11', position:'absolute', top: '100px', transform: `rotate(${rotation}deg)`,transition: isSpinning ? "transform 5s cubic-bezier(0.25, 0.1, 0.25, 1)" : "none",transformOrigin: "center" }} alt="Wheel" />
            ...
            <img src="img/pages/home/menu/triangle.png" style={{width: '58px', display:'flex',  zIndex:'10',  position:'absolute', top: '15px'}} alt="Wheel" />
